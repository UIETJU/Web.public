...
<head>
  ...
  <link rel="stylesheet" href="./css/chatbot.css<?php echo "?t=" . time(); ?>" />
  ...
  <section class="home-hero" id="home">
    <div class="home-hero__content">
      ...
      <!--div class="home-hero__cta">
        <a href="#admission" class="btn btn--bg">Lateral Entry 2023</a>
      </div>
    </div-->
  </section>
    ...
    <div class="main-container">
      <h2 class="heading heading-sec heading-sec__mb-med">
        ...
        <span class="heading-sec__sub">
          The University Institute of Engineering & Technology (UIET) was
          established by the University of Jammu in 2017 as a ‘Centre of
          Excellence to provide quality education in Engineering & Technology.
          <br />
          <br />
          The First Academic Session for B.Tech. programme in UIET started in
          2017 under the centrally sponsored Rashtriya Uchchattar Shiksha
          Abhiyan (RUSA) with two streams in Engineering
          <strong>Civil Engineering (C.E.)</strong> and
          <strong>Computer Science Engineering (C.S.E.)</strong> with an
          intake of <strong>60</strong> in each stream. UIET has the
          distinction of being inaugrated by the Prime Minister of India, Shri
          Narendra Modi ji!
        </span>
      </h2>
      <div class="about__content">
        <div class="about__content-main">
          <h3 class="about__content-title">
            <i style="color: red" class="fa-solid fa-location-dot fa-sm"></i>
            Location
          </h3>
          <div class="about__content-details">
            <p class="about__content-details-para">
              ...
              <a target="_blank" class="blue-link top-space" href="https://maps.app.goo.gl/BrSA1ZLaXqr8aXPMA">View on
                Google Maps</a>
            </p>
          </div>
        </div>
        <div class="about__content-facilities">
          <h3 class="about__content-title">
            <i style="color: coral" class="fa-solid fa-house fa-sm"></i>
            Facilities
          </h3>
          <div class="facilities">
            <div class="facilities_facility">Hostel Facility</div>
            <div class="facilities_facility">Workshop</div>
            <div class="facilities_facility">Bus Facility</div>
            <div class="facilities_facility">Modern Laboratories</div>
        ...
        <div class="projects__row">
          ...
          <div class="projects__row-content">
            ...
            <div class="side-img-link-container">
              ...
              <!--div class="dropdown">
                <a 
                  href="./documents/Seat_Matrix.pdf" class="btn btn--theme dynamicBgClr">Seat Matrix </a>
                <div class="dropdown-lists">
                  <a href="./documents/Selection_List14.pdf">Selection List 14<span class="sep-text">(Reserved
                    Categories)</span> </a>
                  <a href="./documents/Selection_List13.pdf">Selection List 13<span class="sep-text">(Reserved
                    Categories)</span></a>
                  <a href="./documents/Selection_List12.pdf">Selection List 12(CE)</a>
                  <a href="./documents/Selection_List11.pdf">Selection List 11(CSE)<span class="sep-text">(Reserved
                    Categories)</span></a>
                  <a href="./documents/Selection_List10.pdf">Selection List 10(CE)</a>
                  <a href="./documents/Selection_List09U.pdf">Selection List 9(CSE)<span class="sep-text">(Reserved
                    Categories)</span></a>
                  <a href="./documents/Selection_List08.pdf">Selection List 8</a>
                  <a href="./documents/Selection_List07.pdf">Selection List 7</a>
                  <a href="./documents/Selection_List_06.pdf">Selection List 6</a>
                  <a href="./documents/Selection List_(Category Wise).pdf">Selection List 5<span class="sep-text">(Reserved
                    Category)</span></a>
                  <a href="./documents/Selection_list04.pdf">Selection List 4</a>
                  <a href="./documents/Selection_List_3.pdf">Selection List 3</a>
                  <a href="./documents/Selection_list2.pdf">Selection List 2</a>
                  <a href="./documents/selection_list1.pdf">Selection List 1</a>
                </div-->
            </div>
          </div>
        </div>
