        ...
        <div class="notifications-wrapper">
            <div class="notifications-container">
                ...
                foreach ($types as $type) {
                    ...
                    echo "</div>";
                    echo "<a href="https://drive.google.com/drive/folders/1KQXPjhaNkt4hwJBelqJ4BnIu3Vgqq0gGTXrUFT2g8A84ETIfQQMGvUJb1XhdAwpXDaKSjWDN" class='alt-btn btn'><i class="fa-solid fa-box-archive fa-sm">Archive</i></a>";
                    echo "</div>";
                }
                $conn->close();
                ?>
