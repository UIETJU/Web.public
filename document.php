...
<head>
    ...
    <title>
        Documents - University Institute of Engineering and Technology, Kathua Campus, University of Jammu
    </title>
...
<body>
    ...
    <section class="projects sec-pad--top">
        <div class="main-container">
            <h2 class="heading heading-sec heading-sec__mb-bg">
                <span class="heading-sec__main">Documents</span>
                <span class="heading-sec__sub center-text"> </span>
            </h2>
        </div>
    </section>
    <div class="document-row" id="left">
        <img src="assets/png/logo4.png" alt="Image 1" class="image">
    ...
    <div class="document-row" id="left">
        <img src="assets/png/GoI.png" alt="Image 1" class="image">
        <div class="description">
    ...
    <div class="document-row" id="right">
        <img src="assets/png/uiet_header.png" alt="Image 2" class="image">
        <div class="description">
